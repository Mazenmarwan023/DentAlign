...
import Radiology from "../features/staff/pages/Radiology";
...
const routes = [
  ...
  },
  {
    ...
    element: (
      <RoleBasedRoute allowedRoles={['Doctor', 'Nurse', 'Staff']}>
        <StaffLayout><Radiology /></StaffLayout>
      </RoleBasedRoute>
    ),
  },
  {
  ...
  },
  {
    ...
    element: (
      <RoleBasedRoute allowedRoles={['Doctor', 'Nurse', 'Staff']}>
        <StaffLayout><StaffReports /></StaffLayout>
      </RoleBasedRoute>
    ),
  },
  {
  ...
  },
  {
    ...
    element: (
      <RoleBasedRoute allowedRoles={['Doctor', 'Nurse', 'Staff']}>
        <StaffLayout><DicomViewer /></StaffLayout>
      </RoleBasedRoute>
    ),
  },
